...
function isUaSamplingEnabled() {
  return process.env.UA_SAMPLING_MODE === 'true';
}
...
function logUserAgentSample(userAgent) {
  if (!isUaSamplingEnabled()) return;
  console.log('[server]', 'Client User-Agent:', sanitizeForLogging(userAgent));
}
